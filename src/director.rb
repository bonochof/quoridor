...
class Director
  ...
  def play
    ...
    when 2
      ...
      when :wall
        @p2_wall[@p1_wnum].move( :up ) if @key[:p2_up] and @p2_wall.movable?( :up )
        @p2_wall[@p1_wnum].move( :down ) if @key[:p2_down] and @p2_wall.movable?( :down )
        @p2_wall[@p1_wnum].move( :left ) if @key[:p2_left] and @p2_wall.movable?( :left )
        @p2_wall[@p1_wnum].move( :right ) if @key[:p2_right] and @p2_wall.movable?( :right )
      end
    end
